...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const instrumentPianoButton = document.getElementById('instrument-piano') as HTMLButtonElement;
    const instrumentViolinButton = document.getElementById('instrument-violin') as HTMLButtonElement;
    ...
    document.addEventListener('instrumentModeChanged', (event: Event) => {
    ...
    instrumentPianoButton.addEventListener('click', () => {
        game.setInstrumentMode('piano');
        updateToggleButtonsText();
    });

    instrumentViolinButton.addEventListener('click', () => {
        game.setInstrumentMode('violin');
        updateToggleButtonsText();
    });
    ...
    function updateToggleButtonsText() {
        ...
        const currentMode = game.getInstrumentMode();
        if (currentMode === 'piano') {
            instrumentPianoButton.classList.add('active');
            instrumentViolinButton.classList.remove('active');
        } else {
            instrumentViolinButton.classList.add('active');
            instrumentPianoButton.classList.remove('active');
        }
    }
